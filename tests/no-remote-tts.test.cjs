...
const words = fs.readFileSync(path.join(ROOT, 'tools', 'generate_audio.py'), 'utf8');
if (!words.includes('Generate one MP3 pronunciation clip for every Farsi curriculum entry.')) {
