// Pre-render storage validation for the four-step guided lesson.
(() => {
  ...
  function sanitizeGuidedDay() {
    ...
    if (todayCorrect) {
      Object.assign(day.script, { studyComplete: true, phase: 'today', todayAnswered: true, todaySelected: todayIndex, todayCorrect: true });
