const CACHE = 'farsi-daily-cache-v44';
const ASSETS = [
  './', './index.html', './privacy.html', './support.html', './styles.css', './settings.css?v=1',
  './confirmation-dialog.css?v=1', './legal.css?v=1', './verb-upgrade.css', './learning-upgrade.css',
  ...
  './confirmation-dialog.js?v=1', './speech-fix.js?v=9', './learning-upgrade.js?v=3', './guided-learning.js?v=3',
