const CACHE = 'farsi-daily-cache-v38';
const ASSETS = [
  ...
  './word-fit-v1.css?v=1', './words.js', './words-part-01.js', './words-part-02.js',
  ...
  './runtime-integrity-v3.js?v=1', './copy-polish-v1.js?v=1', './layout-polish-v1.js?v=1',
